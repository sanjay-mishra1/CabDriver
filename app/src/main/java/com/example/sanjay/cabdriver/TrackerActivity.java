...
package com.example.sanjay.cabdriver;
...
import com.example.sanjay.cabdriver.NewTrip.NewTrip;
...
public class TrackerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseCrash.log("Activity started");
         mEmailEditText = (EditText) findViewById(R.id.phone);
        ...
        String transportID = mPrefs.getString(getString(R.string.transport_id), "");
          phone = mPrefs.getString(getString(R.string.email), "");
        String password = mPrefs.getString(getString(R.string.password), "");

         mEmailEditText.setText(phone);
        ...
        } else if (transportID.length() > 0 && phone.length() > 0 && password.length() > 0) {
...
//            editor.putString(getString(R.string.route), mRouteEditText.getText().toString());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSwitch.setEnabled( mEmailEditText.length() > 0 &&
                mPasswordEditText.length() > 0);
...
//                        mTransportIdEditText.setEnabled(true);
    ...
    private void newTripListener(){
        FirebaseDatabase.getInstance().getReference("CAR/"+phone+"/TRIP_STATUS").addChildEventListener(new ChildEventListener() {
            @Override
            ...
            public void onChildChanged(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                if (s!=null& s.equals("TRIP_ACTIVE")){
                    makeSnackbar("New Trip Active",(String)dataSnapshot.child("tripid").getValue());
                }else{
                    try{
    ...
    private void makeSnackbar(String status, final String ...extra){
          snackbarMain = Snackbar
                ...
                .setAction(R.string.enable, new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent=new Intent(TrackerActivity.this,NewTrip.class);
                        intent.putExtra("TRIPID",extra[0]);
                        startActivity(intent);
                    }
                });

        // Changing message text color
        snackbarMain.setActionTextColor(Color.RED);
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            com.example.sanjay.cabdriver.Settings settings=new com.example.sanjay.cabdriver.Settings();
            switch (item.getItemId()) {
                ...
                case R.id.navigation_trip:
                    fragmentTransaction1.
                            replace(R.id.frameLayout, allTrip).commit();
                    relativeLayout.setVisibility(View.GONE);
                    frameLayout.setVisibility(View.VISIBLE);
                    return true;
                case R.id.navigation_settings:
                    fragmentTransaction1.
                            replace(R.id.frameLayout, settings).commit();
                    relativeLayout.setVisibility(View.GONE);
                    frameLayout.setVisibility(View.VISIBLE);
                     return true;
            }
